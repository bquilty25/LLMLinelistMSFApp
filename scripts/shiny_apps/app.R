...
source(here::here("scripts", "core", "llm_call_functions.r"), local = TRUE)
source(here::here("scripts", "core", "llm_extraction_functions.R"), local = TRUE)
source(here::here("scripts", "core", "deduplication_functions.R"), local = TRUE)
source(here::here("scripts", "core", "prompt_generation_functions.R"), local = TRUE)

extract_docx_markdown <- get("extract_docx_markdown", mode = "function")
process_full_document_xml <- get("process_full_document_xml", mode = "function")
consolidate_duplicates_llm <- get("consolidate_duplicates_llm", mode = "function")
generate_extraction_prompt <- get("generate_extraction_prompt", mode = "function")

default_system_prompt_path <- here::here(
  "data",
  "system_prompts",
  "system_prompt_ebola_narrative.txt"
)

default_demo_narrative_path <- here::here(
  "data",
  "demos",
  "synthetic_msf_demo_12_cases_v4_narrative.txt"
)
